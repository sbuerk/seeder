...
final class DocumentedSeedSetTest extends AbstractFunctionalTestCase
{
    ...
    private const CAPTION_PREFIX = 'packages/my_extension/Configuration/Seeder/complete/';
    private const SET = 'Tests/Functional/Fixtures/Extensions/seeds-import/Configuration/Seeder/documented';
