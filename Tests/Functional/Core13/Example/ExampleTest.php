...
namespace SBUERK\Seeder\Tests\Functional\Core13\Example;

use PHPUnit\Framework\Attributes\Group;
use PHPUnit\Framework\Attributes\Test;
use SBUERK\Seeder\Core13\Example\Example;
use SBUERK\Seeder\Example\ExampleInterface;
...
final class ExampleTest extends AbstractFunctionalTestCase
{
    ...
    {
        $otherImplementation = 'SBUERK\\Seeder\\Core14\\Example\\Example';
